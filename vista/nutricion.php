        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="background:white !important;">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" id="submitDNI" style="background:#0b326b!important;margin-top:10px;"><i
                ...
                <div class="col-md-12 col-sm-12" style="position: relative;padding-top:70px;padding-bottom:20px;">
                    <div class="home-video"
                        ...
                        <div class="embed-responsive embed-responsive-16by9">
                            <iframe width="1903" height="750" src="https://www.youtube.com/embed/gc1yM-9Dg4k"
                                title="Curso de Nutrición" frameborder="0"
