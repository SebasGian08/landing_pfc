    ...
    <section class="navbar custom-navbar navbar-fixed-top" role="navigation">
        <div class="container">
            <div class="navbar-header d-flex justify-content-between align-items-center">
                <a href="https://www.ial.edu.pe/landing_pfc/manejodeheridas"
                ...
                <div class="col-md-12 col-sm-12" style="position: relative;padding-top:70px;padding-bottom:20px;">
                    <div class="home-video"
                        ...
                        <div class="embed-responsive embed-responsive-16by9">
                            <iframe width="1903" height="750" src="https://www.youtube.com/embed/w8F2hBv5VBY"
                                title="Curso Manejo Integral de Heridas" frameborder="0"
