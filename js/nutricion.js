$(document).ready(function() {
    ...
    function checkDniModal() {
        const lastShown = localStorage.getItem('dniModalNutricionLastShown');
    ...
    $('#submitDNI').click(function(event) {
        ...
        $.ajax({
            url: 'index.php?vista=BuscarAlumnoPorNutricion',
            method: 'POST',
            data: { documento: dni },
